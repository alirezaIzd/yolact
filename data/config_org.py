...
siwei_dataset = my_dataset_base.copy({
    'name': 'siwei_dataset',

    'train_images': './data/coco/images/train_data_dataset_coco/JPEGImages/',
    'train_info':   './data/coco/images/train_data_dataset_coco/annotations.json',

    'valid_images': './data/coco/images/test_data_dataset_coco/JPEGImages/',
    'valid_info':   './data/coco/images/test_data_dataset_coco/annotations.json',

    'has_gt': True,
    'class_names': SIWEI_CLASSES,
    'label_map':SIWEI_LABEL_MAP
})
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': siwei_dataset,
    'num_classes': len(siwei_dataset.class_names) + 1,
